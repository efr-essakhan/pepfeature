...
def calc_csv(dataframe: object, k: int, save_folder: str, aa_column: str = 'Info_window_seq', Ncores: int = 1, chunksize: int = None):
    ...
    """
    utils.calculate_export_csv(dataframe=dataframe, function=utils._execute_all_routines, Ncores=Ncores,
...
def calc_df(dataframe: object, k: int, Ncores: int = 1, aa_column: str = 'Info_window_seq'):
    ...
    return utils.calculate_return_df(dataframe=dataframe, function=utils._execute_all_routines, Ncores=Ncores,
